"""
_summary_
kill switch pnl/close for hyperliquid
"""
import util_funcs as n
...
def bot():
    ...
    # if my account size goes under $100, 
    acct_val = float(n.acct_bal(account))
    if acct_val < acct_min:
        print(f'account value is {acct_val} and closing because our low is {acct_min}')
